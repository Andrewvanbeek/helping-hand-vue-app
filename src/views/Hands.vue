<template>
  <div>
    ...
    <div class="container-fluid mt--7">
      <div class="row">
        <div class="col">
          <projects-table title="In flight Donations heading Towards your Hospital"></projects-table>
        </div>
      </div>
      <div class="row mt-5">
        <div class="col">
...
<script>
import ProjectsTable from "./Tables/MessagesTable";
...
export default {
  ...
  mounted() {
    ...
    axios
      .get("https://services1.arcgis.com/Hp6G80Pky0om7QvQ/arcgis/rest/services/Hospitals_1/FeatureServer/0/query?where=1%3D1&outFields=*&outSR=4326&f=json")
